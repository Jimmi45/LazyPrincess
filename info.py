...
API_ID = int(environ['22569879'])
API_HASH = environ['a193cad6eba083a1cbd4ecf909578159']
BOT_TOKEN = environ['6791087046:AAF7--cwJcrYMA0fogKv201JLJ1LG8qdBcY']

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', False))
PICS = (environ.get('PICS', 'https://telegra.ph/file/f0586d8fb221e31fd7a82.jpg')).split()
 
# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('6793909122', '').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('https://t.me/+BiGCRRcol0AzY2Jl', '0').split()]
...
# MongoDB information
DATABASE_URI = environ.get('mongodb+srv://jimmi45:jimmi45pass@cluster0.mrzul47.mongodb.net/?retryWrites=true&w=majority', "")
DATABASE_NAME = environ.get('DATABASE_NAME', "Jimmi")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('-1002042650123', 0))
...
DOWNLOAD_TEXT_URL = "https://t.me/new_movie_20236/272 "
